...
## 📋 ステップ2: Google Apps Scriptプロジェクトを作成

1. [Google Apps Script](https://script.google.com) にアクセス
2. 「新しいプロジェクト」をクリック
3. プロジェクト名を「POS連携」などに変更

## 📋 ステップ3: コードをコピペ

**以下のコードを全選択してコピーし、Google Apps Scriptに貼り付けてください：**
...
## 📋 ステップ6: URLを.envファイルに設定

コピーしたURLを.envファイルに追加：
```
...
これで設定完了です。アプリの「接続テスト」ボタンを押してみてください！